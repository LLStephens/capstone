...
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. John', 1, '$50', '8:00', '17:00', false, 'Drjohn','doctorNUmber1');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Admin', 1, '$55', '8:00', '17:30', true, 'Dradmin','doctorNUmber2');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Cool', 1, '$65', '9:00',  '16:00', false, 'Drcool','doctorNUmber3');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Smith', 2, '$50', '9:00', '17:00', true, 'Drsmith','doctorNUmber4');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Low', 2, '$50', '7:00', '15:00', false, 'Drlow','doctorNUmber5');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. High', 2, '$60', '9:00', '17:00', false, 'Drhigh','doctorNUmber6');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Joe', 3, '$40', '11:00', '21:00', false, 'Drjoe','doctorNUmber7');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Ben', 3, '$50', '9:00', '17:00', true, 'Drben','doctorNUmber8');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Yu', 3, '$60', '8:00', '16:00', false, 'Dryu','doctorNUmber9');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Chen', 4, '$50', '9:00','17:00', false, 'Drchen','doctorNUmber10');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Lu', 4, '$75', '7:00', '15:00', true, 'Drlu','doctorNUmber11');
INSERT INTO doctor (name, office_id, fee, start_time, end_time, admin, user_name, password) VALUES ('Dr. Pent', 4, '$80', '9:00','18:00', false, 'Drpent','doctorNUmber12');
